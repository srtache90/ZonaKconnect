    ...
    public SecurityFilterChain portalSecurityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/portal/facturacion/manual").hasAnyRole("ADMIN", "OPERADOR")
                        .requestMatchers(HttpMethod.POST, "/portal/facturacion/manual/**").hasAnyRole("ADMIN", "OPERADOR")
                        .requestMatchers(HttpMethod.POST, "/portal/invoices/emit", "/portal/invoices/*/reemit").hasAnyRole("ADMIN", "OPERADOR")
    ...
    public SecurityWebFilterChain portalReactiveSecurityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers("/portal/facturacion/manual").hasAnyRole("ADMIN", "OPERADOR")
                        .pathMatchers("/portal/facturacion/manual/**").hasAnyRole("ADMIN", "OPERADOR")
                        .pathMatchers("/portal/invoices/emit").hasAnyRole("ADMIN", "OPERADOR")
